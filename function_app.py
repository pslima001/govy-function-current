...
# ============================================================
# TIMER TRIGGER: legal_watch (diario 06:00 UTC = 03:00 BRT)
# ============================================================
@app.function_name(name="legal_watch_timer")
@app.timer_trigger(arg_name="timer", schedule="0 0 6 * * *")
...
# ============================================================
# HTTP TRIGGER: legal_watch_run (seed/manual, 1 lista por vez)
# ============================================================
@app.function_name(name="legal_watch_run")
@app.route(route="legal/watch/run", methods=["POST"], auth_level=func.AuthLevel.FUNCTION)
